				...
				success: function (data, textStatus) 
				{
					...
					for(var action in permissions)
					{
						...
						if(permissions[action] == true || permissions[action] == false)
						{
							...
							{
								icon_html = "<img src=\"" + app_root_url + "/img/design/tick.png"  + "\" class=\"pointer\" alt=\"granted\" />";
								start_granted = true;
							}
							else
							{
								icon_html = "<img src=\"" + app_root_url + "/img/design/cross.png"  + "\" class=\"pointer\" alt=\"denied\" />";
								start_granted = false;
							}
						...
						{
							icon_html = "<img src=\"" + app_root_url + "/img/design/important16.png"  + "\" alt=\"" + missing_aco_text + "\" title=\"" + missing_aco_text + "\" />";
