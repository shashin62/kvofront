...
echo '<span id="right_' . $plugin . '_' . $role_id . '_' . $controller_name . '_' . $action . '">';
    ...
    if(isset($acl_error))
    {
        ...
        echo $this->Html->image('/img/design/important16.png', array('class' => 'pointer', 'alt' => $title, 'title' => $title));
    }
    else
    {
        echo $this->Html->image('/img/design/cross.png', array('class' => 'pointer', 'alt' => 'denied'));
    }
