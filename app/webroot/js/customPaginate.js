jQuery.fn.pagination = function(maxentries,perpage, curpage,opts){
    opts = jQuery.extend({
        items_per_page: perpage,
        num_display_entries: perpage,
        ...
        function drawLinks() {
            ...
            var appendItem = function(page_id, appendopts){
                ...
                if(page_id == current_page){
                    ...
                    var lstItem = jQuery("<li class='paginate_button "+clazz+"'><a>"+(appendopts.text)+"</a></li>")
                }
                else
                {
